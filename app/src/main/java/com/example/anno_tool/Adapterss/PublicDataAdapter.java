...
public class PublicDataAdapter extends FirestoreRecyclerAdapter<SharedDataNote,PublicDataAdapter.PublicViewHolder> {
     ...
     * @param options
     */
    public PublicDataAdapter(@NonNull FirestoreRecyclerOptions<SharedDataNote> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull PublicViewHolder holder, int position, @NonNull SharedDataNote model) {
    ...
    public  void setOnItemClickListener(PublicDataAdapter.OnItemClickListener listener){
